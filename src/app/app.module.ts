...
@NgModule({
  ...
  providers: [BreadcrumbService, UserService, DataUserService,InsuranceService,DataInsuranceService,ClientService,DataClientService,VehicleService,DataVehicleService],
